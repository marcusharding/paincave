    ...
    render() {
        ...
        const widget = fakeArray.map(() =>
            <div className="flex flex-col items-center">
                ...
                <p className="text-white text-center pt-12 w-3/4">Lorem ipsum dolor sit amet, consetetur Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet, consetetur Lorem ipsum dolor sit amet.</p>
            </div>
        )
