...
export class Burger extends React.Component {
    render() {
        return (
            <a href="/" target="_blank" id="mobileMenu" data-menu-button aria-controls='site-nav' aria-expanded='false' className={`o-burger ml-4 hidden relative z-20 text-black cursor-pointer lg:flex items-end lg:items-center ${this.props.state ? 'fade-in-extended': ''}`}>
